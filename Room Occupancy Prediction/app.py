...
def predict():
    ...
    if prediction == 0:
        return render_template('index.html', prediction_text="No Chances for Room Occupancy").format(prediction)
    else:
        return render_template('index.html', prediction_text="Chances for Room Occupancy").format(prediction)
